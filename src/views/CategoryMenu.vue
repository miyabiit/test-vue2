    ...
    <main id="catalog" class="order-1 order-md-2 col-12 col-md-9 py-0 px-0 pl-md-5 mt-3 mt-md-0 mx-0 bd-content" role="main">
      ...
      <div id="special_search" class="row row-eq-height mt-1 mb-4 mx-0">
        <div class="col-4 border p-2">
          <router-link class="d-block text-center clearfix p-3" :to="{ name: 'catlist', params: { Name: '新入荷'}}"><img src="@/assets/images/special01.jpg" class="d-block mx-auto mb-2"><span class="d-block">新入荷商品</span></router-link>
        </div>
        <div class="col-4 border p-2">
      ...
      <div id="top_rental" class="row row-eq-height mt-1 mb-4 mx-0">
        <div class="col-4 border p-2">
          <a href="document/general-conditions/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/rental.jpg" class="d-block mx-auto mb-2"><span class="d-block">レンタル約款</span></a>
        </div>
        <div class="col-4 border p-2">
          <a href="document/rental-support/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/support.jpg" class="d-block mx-auto mb-2"><span class="d-block">レンタル物件サポート特約制度</span></a>
        </div>
        <div class="col-4 border p-2">
          <a href="document/special-contract/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/guarantee.jpg" class="d-block mx-auto mb-2"><span class="d-block">レンタル保障制度</span></a>
        </div>
        <div class="col-4 border p-2">
          <a href="document/law/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/law.jpg" class="d-block mx-auto mb-2"><span class="d-block">法規</span></a>
        </div>
        <div class="col-4 border p-2">
          <a href="document/qualification/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/certificate.jpg" class="d-block mx-auto mb-2"><span class="d-block">資格</span></a>
        </div>
        <div class="col-4 border p-2">
          <a href="document/unit/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/unit.jpg" class="d-block mx-auto mb-2"><span class="d-block">単位</span></a>
        </div>
        <div class="col-4 border p-2">
          <a href="document/guide/index.html" class="d-block text-center clearfix h-100 p-3"><img src="@/assets/images/guide.jpg" class="d-block mx-auto mb-2"><span class="d-block">ご利用ガイド</span></a>
        </div>
      </div>
    </main>
</template>
